(function Game() {
    ...
    var turnDisplay = document.getElementById('track-turn');
    var gameMessages = document.getElementById('result');
    var playerOneScoreCard = document.getElementById('player1');
    var playerTwoScoreCard = document.getElementById('player2');
    
    // Vars
    var context = { 'playerOne' : 'X', 'playerTwo' : 'O' };
    var board = [];
    ...
    var computeContext = function() {
        return (turns % 2 == 0) ? context.playerOne : context.playerTwo;
    }
